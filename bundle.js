	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            Link,
	            { to: '/#home', className: 'button py2 button-transparent' },
	            'Home'
	          ),
	          React.createElement(
	            'a',
	            { href: '/#summary', className: 'button py2 button-transparent' },
	            'Summary'
	          ),
	          React.createElement(
	            'a',
	            { href: '/#portfolio', className: 'button py2 button-transparent' },
	            'Portfolio'
	          ),
	          React.createElement(
	            'a',
	            { href: '/#resume', className: 'button py2 button-transparent' },
	            'Resume'
	          ),
	          React.createElement(
	            Link,
