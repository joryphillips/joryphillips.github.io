...
`;function Be({project:e,handleInfoClick:t,handleInfoCloseClick:i,selected:s}){Ie((()=>{!function(e,t){const i=new IntersectionObserver((e=>{for(const s of e)if(s.isIntersecting){const e=s.target;t(e),i.unobserve(e)}}));i.observe(e)}(this,Ne)}),[]);const o="./images/"+e.imageSources[0];return j`
    ${Ge}
...
`;const{component:Je}=Me({render:H});function Xe(e){e.preventDefault();const t=e.target.hash,i=document.querySelector(t),s=document.querySelector(De.HEADER),o=s?s.offsetHeight:0;if(i){const e=i.offsetTop-o;window.scroll({top:e,behavior:"smooth"}),history.pushState(null,null,t)}}customElements.define("project-list",Je((function(){const[e,t]=He(""),[i,s]=He(null),[o,n]=He(null),r=e=>{n(window.scrollY);const t=this.shadowRoot.querySelector("section");scrollTo({top:t.offsetTop}),s(Le(e.title))},a=()=>{var e,t;s(null),e=()=>scrollTo({top:o}),t=this,requestAnimationFrame((()=>{requestAnimationFrame((()=>{e.apply(t)}))})),n(null)},l=e=>Le(e.title)===i,d=qe.filter((t=>function(e,t){const{keywords:i,title:s}=t;return function(e,t){let i=!1;const s=e.toLowerCase().split(" ");for(let e=0;e<s.length;e++){const o=s[e].trim();i=t.toLowerCase().includes(o)}return i}(e,i.join(" ")+" "+s.toLowerCase())}(e,t)));return j`
    ${We}
    ...
    <section class="border-bottom border-top">
      <div class="visuals-header">
        ...
        <search-box
          ?hidden=${!!i}
          .keyWords=${function(e){const t=new Set;if(e)for(const i of e)for(const e of i.keywords)t.add(e.toLowerCase());return t}(qe)}
