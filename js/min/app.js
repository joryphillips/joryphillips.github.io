...
`;function st(e){return e.toLowerCase().replace(/[^a-z0-9]+/gi,"-")}
/**
@license
...
`;customElements.define("nav-bar",tt((function({navFocus:e=""}){return Ke((()=>{!function(e,t){const i=t.shadowRoot?.querySelectorAll("a");if(!i)return;if(!e){for(const e of Array.from(i))e.blur();return}Array.from(i).find((t=>t.hash===e))?.focus()}(e,this)}),[e]),de`
    ${ht}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{H:ft}=V,vt=()=>document.createComment(""),bt=(e,t,i)=>{var s;const o=e._$AA.parentNode,n=void 0===t?e._$AB:t._$AA;if(void 0===i){const t=o.insertBefore(vt(),n),s=o.insertBefore(vt(),n);i=new ft(t,s,e,e.options)}else{const t=i._$AB.nextSibling,r=i._$AM,a=r!==e;if(a){let t;null===(s=i._$AQ)||void 0===s||s.call(i,e),i._$AM=e,void 0!==i._$AP&&(t=e._$AU)!==r._$AU&&i._$AP(t)}if(t!==n||a){let e=i._$AA;for(;e!==t;){const t=e.nextSibling;o.insertBefore(e,n),e=t}}}return i},yt=(e,t,i=e)=>(e._$AI(t,i),e),$t={},_t=e=>{var t;null===(t=e._$AP)||void 0===t||t.call(e,!1,!0);let i=e._$AA;const s=e._$AB.nextSibling;for(;i!==s;){const e=i.nextSibling;i.remove(),i=e}},wt=(e,t,i)=>{const s=new Map;for(let o=t;o<=i;o++)s.set(e[o],o);return s},At=mt(class extends gt{constructor(e){if(super(e),e.type!==pt)throw Error("repeat() can only be used in text expressions")}dt(e,t,i){let s;void 0===i?i=t:void 0!==t&&(s=t);const o=[],n=[];let r=0;for(const t of e)o[r]=s?s(t,r):r,n[r]=i(t,r),r++;return{values:n,keys:o}}render(e,t,i){return this.dt(e,t,i).values}update(e,[t,i,s]){var o;const n=(e=>e._$AH)(e),{values:r,keys:a}=this.dt(t,i,s);if(!Array.isArray(n))return this.ct=a,r;const l=null!==(o=this.ct)&&void 0!==o?o:this.ct=[],d=[];let c,h,u=0,p=n.length-1,m=0,g=r.length-1;for(;u<=p&&m<=g;)if(null===n[u])u++;else if(null===n[p])p--;else if(l[u]===a[m])d[m]=yt(n[u],r[m]),u++,m++;else if(l[p]===a[g])d[g]=yt(n[p],r[g]),p--,g--;else if(l[u]===a[g])d[g]=yt(n[u],r[g]),bt(e,d[g+1],n[u]),u++,g--;else if(l[p]===a[m])d[m]=yt(n[p],r[m]),bt(e,n[u],n[p]),p--,m++;else if(void 0===c&&(c=wt(a,m,g),h=wt(l,u,p)),c.has(l[u]))if(c.has(l[p])){const t=h.get(a[m]),i=void 0!==t?n[t]:null;if(null===i){const t=bt(e,n[u]);yt(t,r[m]),d[m]=t}else d[m]=yt(i,r[m]),bt(e,n[u],i),n[t]=null;m++}else _t(n[p]),p--;else _t(n[u]),u++;for(;m<=g;){const t=bt(e,d[g+1]);yt(t,r[m]),d[m++]=t}for(;u<=p;){const e=n[u++];null!==e&&_t(e)}return this.ct=a,((e,t=$t)=>{e._$AH=t})(e,d),H}}),xt=mt(class extends gt{constructor(e){var t;if(super(e),e.type!==ut||"class"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){var i,s;if(void 0===this.st){this.st=new Set,void 0!==e.strings&&(this.et=new Set(e.strings.join(" ").split(/\s/).filter((e=>""!==e))));for(const e in t)t[e]&&!(null===(i=this.et)||void 0===i?void 0:i.has(e))&&this.st.add(e);return this.render(t)}const o=e.element.classList;this.st.forEach((e=>{e in t||(o.remove(e),this.st.delete(e))}));for(const e in t){const i=!!t[e];i===this.st.has(e)||(null===(s=this.et)||void 0===s?void 0:s.has(e))||(i?(o.add(e),this.st.add(e)):(o.remove(e),this.st.delete(e)))}return H}}),St=de`
  <style>
    :host {
      position: relative;
      flex: 2 1 auto;
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */customElements.define("search-input",tt((function({keyWords:e=new Set,handleSearchInput:t=kt}){const[i,s]=et(!1),[o,n]=et(void 0),[r,a]=et(null),[l,d]=et(""),c=this.shadowRoot?.querySelector("#listbox"),h=e=>{d(e),s(!i),t(e)};return de`
    ${St}
    <div
      id="combobox"
      role="combobox"
...
`;function jt(e){const t=e.shadowRoot?.querySelector(nt.PROJECT_IMAGE);t&&t.dataset.src&&(t.src=t.dataset.src,async function(e,t){e.src.indexOf("heathrow-clock.svg")>-1&&(await import("./clock-8b7f62f2.js")).addClockPrototype(e,t)}(t,e),t.classList.add("visible"))}customElements.define("project-card",tt((function({project:e,selected:t}){Ke((()=>{!function(e,t){const i=new IntersectionObserver((e=>{for(const s of e)if(s.isIntersecting){const e=s.target;t(e),i.unobserve(e)}}));i.observe(e)}(this,jt)}),[]);const i="./images/"+e.imageSources[0],s=encodeURIComponent(st(e.title));return de`
    ${Ct}
...
`;customElements.define("project-list",tt((function({setSelectedProjectName:e}){const[t,i]=et(""),s=lt.filter((e=>function(e,t){const{keywords:i,title:s}=t;return function(e,t){let i=!1;const s=e.toLowerCase().split(" ");for(let e=0;e<s.length;e++){const o=s[e].trim();i=t.toLowerCase().includes(o)}return i}(e,i.join(" ")+" "+s.toLowerCase())}(t,e)));return de`
    ${Ht}
...
`;customElements.define("project-detail",tt((function({projectName:e}){const t=lt.find((t=>st(t.title)===e));return t?de`
    ${Tt}
  ...
  `:de`<div>No project found</div>`}))),customElements.define("app-component",tt((function(){const[e,t]=et(""),[i,s]=et(""),[o,n]=et(void 0);Ke((()=>{ot({setNavFocus:t,setProject:r})}),[]),Ye((()=>{e&&!i&&function(e,t,i="instant"){if(!t)return;const s=e.querySelector(t),o=e.querySelector(nt.HEADER),n=o?o.offsetHeight:0;if(s){const e=s.offsetTop-n;window.scroll({top:e,behavior:i})}}(this.shadowRoot,e)}),[e,i]),Ke((()=>{!i&&o&&(scrollTo({top:o}),n(void 0))}),[o,i]);const r=e=>{e&&n(window.scrollY),s(st(e))};return de`
    ${it}
