 ...
 * http://polymer.github.io/PATENTS.txt
 */
let Ce,je=!1;(()=>{try{const e={get capture(){return je=!0,!1}};window.addEventListener("test",e,e),window.removeEventListener("test",e,e)}catch(e){}})(),
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.1");let He=0;function Pe(e){Ce=e}function Te(){Ce=null,He=0}const Ie=Symbol("haunted.phase"),Me=Symbol("haunted.hook"),Ne=Symbol("haunted.update"),Ue=Symbol("haunted.commit"),ze=Symbol("haunted.effects"),Re=Symbol("haunted.layoutEffects");class Le{update;host;virtual;[Me];[ze];[Re];constructor(e,t){this.update=e,this.host=t,this[Me]=new Map,this[ze]=[],this[Re]=[]}run(e){Pe(this);let t=e();return Te(),t}_runEffects(e){let t=this[e];Pe(this);for(let e of t)e.call(this);Te()}runEffects(){this._runEffects(ze)}runLayoutEffects(){this._runEffects(Re)}teardown(){this[Me].forEach((e=>{"function"==typeof e.teardown&&e.teardown()}))}}const De=Promise.resolve().then.bind(Promise.resolve());function Oe(){let e,t=[];function i(){e=null;let i=t;t=[];for(var s=0,o=i.length;s<o;s++)i[s]()}return function(s){t.push(s),null==e&&(e=De(i))}}const Be=Oe(),Ge=Oe();class Ve{renderer;host;state;[Ie];_updateQueued;constructor(e,t){this.renderer=e,this.host=t,this.state=new Le(this.update.bind(this),t),this[Ie]=null,this._updateQueued=!1}update(){this._updateQueued||(Be((()=>{let e=this.handlePhase(Ne);Ge((()=>{this.handlePhase(Ue,e),Ge((()=>{this.handlePhase(ze)}))})),this._updateQueued=!1})),this._updateQueued=!0)}handlePhase(e,t){switch(this[Ie]=e,e){case Ue:return this.commit(t),void this.runEffects(Re);case Ne:return this.render();case ze:return this.runEffects(ze)}this[Ie]=null}render(){return this.state.run((()=>this.renderer.call(this.host,this.host)))}runEffects(e){this.state._runEffects(e)}teardown(){this.state.teardown()}}function Fe(e){class t extends Ve{frag;constructor(e,t,i){super(e,i||t),this.frag=t}commit(t){e(t,this.frag)}}return function(e,i,s){const o=(s||i||{}).baseElement||HTMLElement,{observedAttributes:n=[],useShadowDOM:r=!0,shadowRootInit:a={}}=s||i||{};class l extends o{_scheduler;static get observedAttributes(){return e.observedAttributes||n||[]}constructor(){super(),!1===r?this._scheduler=new t(e,this):(this.attachShadow({mode:"open",...a}),this._scheduler=new t(e,this.shadowRoot,this))}connectedCallback(){this._scheduler.update()}disconnectedCallback(){this._scheduler.teardown()}attributeChangedCallback(e,t,i){if(t===i)return;let s=""===i||i;Reflect.set(this,((e="")=>e.replace(/-+([a-z])?/g,((e,t)=>t?t.toUpperCase():"")))(e),s)}}const d=new Proxy(o.prototype,{getPrototypeOf:e=>e,set(e,t,i,s){let o;return t in e?(o=Object.getOwnPropertyDescriptor(e,t),o&&o.set?(o.set.call(s,i),!0):(Reflect.set(e,t,i,s),!0)):(o="symbol"==typeof t||"_"===t[0]?{enumerable:!0,configurable:!0,writable:!0,value:i}:function(e){let t=e,i=!1;return Object.freeze({enumerable:!0,configurable:!0,get:()=>t,set(e){i&&t===e||(i=!0,t=e,this._scheduler&&this._scheduler.update())}})}(i),Object.defineProperty(s,t,o),o.set&&o.set.call(s,i),!0)}});return Object.setPrototypeOf(l.prototype,d),l}}class We{id;state;constructor(e,t){this.id=e,this.state=t}}function Je(e,...t){let i=He++,s=Ce[Me],o=s.get(i);return o||(o=new e(i,Ce,...t),s.set(i,o)),o.update(...t)}function qe(e){return Je.bind(null,e)}function Xe(e){return qe(class extends We{callback;lastValues;values;_teardown;constructor(t,i,s,o){super(t,i),e(i,this)}update(e,t){this.callback=e,this.values=t}call(){this.values&&!this.hasChanged()||this.run(),this.lastValues=this.values}run(){this.teardown(),this._teardown=this.callback.call(this.state)}teardown(){"function"==typeof this._teardown&&this._teardown()}hasChanged(){return!this.lastValues||this.values.some(((e,t)=>this.lastValues[t]!==e))}})}function Qe(e,t){e[ze].push(t)}const Ke=Xe(Qe),Ze=qe(class extends We{Context;value;_ranEffect;_unsubscribe;constructor(e,t,i){super(e,t),this._updater=this._updater.bind(this),this._ranEffect=!1,this._unsubscribe=null,Qe(t,this)}update(e){if(this.state.virtual)throw new Error("can't be used with virtual components");return this.Context!==e&&(this._subscribe(e),this.Context=e),this.value}call(){this._ranEffect||(this._ranEffect=!0,this._unsubscribe&&this._unsubscribe(),this._subscribe(this.Context),this.state.update())}_updater(e){this.value=e,this.state.update()}_subscribe(e){const t={Context:e,callback:this._updater};this.state.host.dispatchEvent(new CustomEvent("haunted.context",{detail:t,bubbles:!0,cancelable:!0,composed:!0}));const{unsubscribe:i=null,value:s}=t;this.value=i?s:e.defaultValue,this._unsubscribe=i}teardown(){this._unsubscribe&&this._unsubscribe()}});qe(class extends We{value;values;constructor(e,t,i,s){super(e,t),this.value=i(),this.values=s}update(e,t){return this.hasChanged(t)&&(this.values=t,this.value=e()),this.value}hasChanged(e=[]){return e.some(((e,t)=>this.values[t]!==e))}}),Xe((function(e,t){e[Re].push(t)}));const Ye=qe(class extends We{args;constructor(e,t,i){super(e,t),this.updater=this.updater.bind(this),"function"==typeof i&&(i=i()),this.makeArgs(i)}update(){return this.args}updater(e){if("function"==typeof e){const t=e,[i]=this.args;e=t(i)}this.makeArgs(e),this.state.update()}makeArgs(e){this.args=Object.freeze([e,this.updater])}});
/**
 * @license
 * Portions Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */Promise.resolve(),qe(class extends We{reducer;currentState;constructor(e,t,i,s,o){super(e,t),this.dispatch=this.dispatch.bind(this),this.currentState=void 0!==o?o(s):s}update(e){return this.reducer=e,[this.currentState,this.dispatch]}dispatch(e){this.currentState=this.reducer(this.currentState,e),this.state.update()}});const{component:et}=function({render:e}){const t=Fe(e),i=function(e){return t=>{const i={Provider:class extends HTMLElement{listeners;_value;constructor(){super(),this.listeners=new Set,this.addEventListener("haunted.context",this)}disconnectedCallback(){this.removeEventListener("haunted.context",this)}handleEvent(e){const{detail:t}=e;t.Context===i&&(t.value=this.value,t.unsubscribe=this.unsubscribe.bind(this,t.callback),this.listeners.add(t.callback),e.stopPropagation())}unsubscribe(e){this.listeners.delete(e)}set value(e){this._value=e;for(let t of this.listeners)t(e)}get value(){return this._value}},Consumer:e((function({render:e}){return e(Ze(i))})),defaultValue:t};return i}}(t);return{component:t,createContext:i}}({render:pe}),tt=de`
  <style>
    :host {
      position: relative;
      display: block;
...
`;function Ct(e){const t=e.shadowRoot?.querySelector(ot.PROJECT_IMAGE);t&&t.dataset.src&&(t.src=t.dataset.src,async function(e,t){e.src.indexOf("heathrow-clock.svg")>-1&&(await import("./clock-1b9e457b.js")).addClockPrototype(e,t)}(t,e),t.classList.add("visible"))}customElements.define("project-card",et((function({project:e,selected:t}){Ke((()=>{!function({element:e,onIntersection:t,unobserve:i=!0,options:s}){const o=new IntersectionObserver((e=>{for(const s of e)s.isIntersecting&&(t(s.target),i&&o.unobserve(s.target))}),s);o.observe(e)}({element:this,onIntersection:Ct})}),[]);const i="./images/"+e.imageSources[0],s=encodeURIComponent(it(e.title));return de`
    ${Et}
...
`;customElements.define("project-detail",et((function({projectName:e}){const t=at.find((t=>it(t.title)===e));return t?de`
  ...
  `:de`<div>No project found</div>`}))),customElements.define("app-component",et((function(){const[e,t]=Ye(""),[i,s]=Ye(""),[o,n]=Ye(void 0);Ke((()=>{st({setNavFocus:t,setProject:r})}),[]),Ke((()=>{!e||i||o||function(e,t){if(!t)return;e.querySelector(t).scrollIntoView()}(this.shadowRoot,e)}),[e,i,o]),Ke((()=>{i||null==o||scrollTo({top:o})}),[o,i]);const r=e=>{if(e){n(window.scrollY);const t=at.find((t=>it(t.title)===e))?.title;document.title=`Jory's ${t} Project`}else document.title="Jory Phillips Portfolio and Resume";s(e)};return de`
    ${tt}
