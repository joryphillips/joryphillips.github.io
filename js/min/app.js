 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */Promise.resolve(),rt(class extends nt{reducer;currentState;constructor(e,t,i,s,n){super(e,t),this.dispatch=this.dispatch.bind(this),this.currentState=void 0!==n?n(s):s}update(e){return this.reducer=e,[this.currentState,this.dispatch]}dispatch(e){this.currentState=this.reducer(this.currentState,e),this.state.update()}});const pt=He(class extends Pe{constructor(e){var t;if(super(e),e.type!==Ce||"class"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){var i,s;if(void 0===this.st){this.st=new Set,void 0!==e.strings&&(this.et=new Set(e.strings.join(" ").split(/\s/).filter((e=>""!==e))));for(const e in t)t[e]&&!(null===(i=this.et)||void 0===i?void 0:i.has(e))&&this.st.add(e);return this.render(t)}const n=e.element.classList;this.st.forEach((e=>{e in t||(n.remove(e),this.st.delete(e))}));for(const e in t){const i=!!t[e];i===this.st.has(e)||(null===(s=this.et)||void 0===s?void 0:s.has(e))||(i?(n.add(e),this.st.add(e)):(n.remove(e),this.st.delete(e)))}return H}}),gt=e=>e,mt={behavior:"smooth",block:"nearest"},ft=de`
    <style>
      :host {
        position: relative;
        flex: 2 1 auto;
...
`;const{component:vt}=ut({render:pe});var bt;function $t(e){return e.toLowerCase().replace(/[^a-z0-9]+/gi,"-")}customElements.define("search-input",vt((function({keyWords:e=new Set,handleSearchInput:t=gt}){const[i,s]=ht(!1),[n,o]=ht(void 0),[r,a]=ht(null),[l,d]=ht(""),c=this.shadowRoot?.querySelector("#listbox"),h=e=>{d(e),s(!i),t(e)};return de`
    ${ft}
    <div
      id="combobox"
      role="combobox"
    ...
    <label for="search" class="hide">Search</label>
      <input
        ...
        @focus=${()=>{s(!0)}}
        @blur=${()=>{a(null),i&&s(!1)}}
        @keyup=${i=>{const{key:n}=i;switch(n){case"ArrowDown":(()=>{let t;s(!0),t=null==r||r===e.size-1?0:r+1,c&&c.children[t].scrollIntoView(mt),a(t)})();break;case"ArrowUp":(()=>{let t;t=null==r||0===r?e.size-1:r-1,c&&c.children[t].scrollIntoView(mt),a(t)})();break;case"Escape":t(""),a(null),s(!1);break;case"Enter":if(null==r)break;d([...e][r]),t([...e][r]),s(!1)}}}
      >
    </div>
  ...
  `}))),function(e){e.HEADER="header",e.PROJECT_IMAGE=".image-container img",e.SEARCH_INPUT='input[type="search"]'}(bt||(bt={}));function yt(e){const t=e.shadowRoot?.querySelector(bt.PROJECT_IMAGE);t&&t.dataset.src&&(t.src=t.dataset.src,async function(e,t){e.src.indexOf("heathrow-clock.svg")>-1&&(await import("./clock-ca22aba1.js")).addClockPrototype(e,t)}(t,e),t.classList.add("visible"))}const _t=de`
  <style>
    :host {
      opacity: 1;
...
`;const{component:At}=ut({render:pe});customElements.define("project-card",At((function({project:e,handleInfoClick:t,handleInfoCloseClick:i,selected:s}){dt((()=>{!function(e,t){const i=new IntersectionObserver((e=>{for(const s of e)if(s.isIntersecting){const e=s.target;t(e),i.unobserve(e)}}));i.observe(e)}(this,yt)}),[]);const n="./images/"+e.imageSources[0];return de`
    ${_t}
...
`;const{component:kt}=ut({render:pe});function Et(e){e.preventDefault();const t=e.target.hash,i=document.querySelector(t),s=document.querySelector(bt.HEADER),n=s?s.offsetHeight:0;if(i){const e=i.offsetTop-n;window.scroll({top:e,behavior:"smooth"}),history.pushState(null,"",t)}}customElements.define("project-list",kt((function(){const[e,t]=ht(""),[i,s]=ht(null),[n,o]=ht(void 0),r=e=>{o(window.scrollY);const t=this.shadowRoot?.querySelector("section");t&&scrollTo({top:t.offsetTop}),s($t(e.title))},a=async()=>{s(null),await new Promise((e=>requestAnimationFrame((()=>requestAnimationFrame((()=>e())))))),scrollTo({top:n}),o(void 0)},l=e=>$t(e.title)===i,d=xt.filter((t=>function(e,t){const{keywords:i,title:s}=t;return function(e,t){let i=!1;const s=e.toLowerCase().split(" ");for(let e=0;e<s.length;e++){const n=s[e].trim();i=t.toLowerCase().includes(n)}return i}(e,i.join(" ")+" "+s.toLowerCase())}(e,t)));return de`
    ${St}
    ...
    <section class="border-bottom border-top">
      <div class="visuals-header">
        ...
        <search-input
          ?hidden=${!!i}
          .keyWords=${function(e){const t=new Set;if(e)for(const i of e)for(const e of i.keywords)t.add(e.toLowerCase());return t}(xt)}
          .handleSearchInput=${e=>{t(e)}}
        ></search-input>
      </div>

      <div class="project-holder">
        ${Oe(d,(e=>$t(e.title)),(e=>de`
              <project-card
  ...
  <header class="navy border-bottom">
    <nav class="container">
      <a href="/#summary" @click=${Et} class="button button-transparent">Summary</a>
      <a href="/#visuals" @click=${Et} class="button button-transparent">Visuals</a>
      <a href="/#experience" @click=${Et} class="button button-transparent">Experience</a>
    </nav>
  </header>
`,Tt=de`
