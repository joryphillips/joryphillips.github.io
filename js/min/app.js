...
`;const{component:Ne}=Ie({render:M});function Le(e){return e.toLowerCase().replace(/[^a-z0-9]+/gi,"-")}customElements.define("search-box",Ne((function({keyWords:e,handleSearchInput:t}){const[i,s]=Me(!1),[n,o]=Me(null),r=this.shadowRoot.querySelector(De.SEARCH_INPUT),a=()=>{s(!i)};return j`
    ${Oe}
