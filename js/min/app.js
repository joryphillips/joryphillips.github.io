...
`;function jt(e){const t=e.shadowRoot?.querySelector(nt.PROJECT_IMAGE);t&&t.dataset.src&&(t.src=t.dataset.src,async function(e,t){e.src.indexOf("heathrow-clock.svg")>-1&&(await import("./clock-1b9e457b.js")).addClockPrototype(e,t)}(t,e),t.classList.add("visible"))}customElements.define("project-card",tt((function({project:e,selected:t}){Ke((()=>{!function(e,t){const i=new IntersectionObserver((e=>{for(const s of e)if(s.isIntersecting){const e=s.target;t(e),i.unobserve(e)}}));i.observe(e)}(this,jt)}),[]);const i="./images/"+e.imageSources[0],s=encodeURIComponent(st(e.title));return de`
    ${Ct}
