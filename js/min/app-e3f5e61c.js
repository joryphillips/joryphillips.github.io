...
`;const{component:Ne}=Me({render:H});customElements.define("search-box",Ne((function({keyWords:e,handleSearchInput:t}){const[i,s]=He(!1),[o,n]=He(void 0),[r,a]=He(null),l=ze(De.SEARCH_INPUT,this),d=ze("#listbox",this),c=e=>{l&&(l.value=e),s(!i),t(e)};return j`
    ${Le}
    <div
      id="combobox"
      role="combobox"
    ...
    <label for="search" class="hide">Search</label>
      <input
        ...
        @focus=${()=>{s(!0)}}
        @blur=${()=>{a(null),i&&s(!1)}}
        @keyup=${i=>{const{key:o}=i;switch(o){case"ArrowDown":(()=>{let t;s(!0),t=null==r||r===e.size-1?0:r+1,d.children[t].scrollIntoView({behavior:"smooth",block:"nearest"}),a(t)})();break;case"ArrowUp":(()=>{let t;t=null==r||0===r?e.size-1:r-1,d&&d.children[t].scrollIntoView({behavior:"smooth",block:"nearest"}),a(t)})();break;case"Escape":t(""),a(null),s(!1);break;case"Enter":if(null==r||!l)break;l.value=[...e][r],t([...e][r]),s(!1)}}}
      >
    </div>
  ...
  `})));function Ge(e){const t=ze(De.PROJECT_IMAGE,e);t.dataset.src&&(t.src=t.dataset.src,async function(e,t){e.src.indexOf("heathrow-clock.svg")>-1&&(await import("./clock-3a12fbaf.js")).addClockPrototype(e,t)}(t,e),t.classList.add("visible"))}const Be=j`
  <style>
    :host {
      opacity: 1;
...
//# sourceMappingURL=app-e3f5e61c.js.map
