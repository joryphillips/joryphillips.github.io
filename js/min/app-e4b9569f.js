...
`;const{component:Ne}=Me({render:H});customElements.define("search-box",Ne((function({keyWords:e,handleSearchInput:t}){const[i,s]=He(!1),[o,n]=He(void 0),[r,a]=He(null);let l;Ie((()=>{l=ze(De.SEARCH_INPUT,this),ze("#listbox",this)}),[]);const d=e=>{l&&(l.value=e),s(!i),t(e)};return j`
    ${Le}
    <div
      id="combobox"
      role="combobox"
    ...
    <label for="search" class="hide">Search</label>
      <input
        ...
        @focus=${()=>{s(!0)}}
        @blur=${()=>{a(null),i&&s(!1)}}
        @keyup=${i=>{const{key:o}=i;switch(o){case"ArrowDown":(()=>{let t;s(!0),t=null==r||r===e.size-1?0:r+1,(void 0).children[t].scrollIntoView({behavior:"smooth",block:"nearest"}),a(t)})();break;case"ArrowUp":(()=>{let t;t=null==r||0===r?e.size-1:r-1,a(t)})();break;case"Escape":t(""),a(null),s(!1);break;case"Enter":if(null==r||!l)break;l.value=[...e][r],t([...e][r]),s(!1)}}}
      >
    </div>
  ...
  `})));function Ge(e){const t=ze(De.PROJECT_IMAGE,e);t.dataset.src&&(t.src=t.dataset.src,async function(e,t){e.src.indexOf("heathrow-clock.svg")>-1&&(await import("./clock-4282ddcf.js")).addClockPrototype(e,t)}(t,e),t.classList.add("visible"))}const Be=j`
  <style>
    :host {
      opacity: 1;
...
`;const{component:Ve}=Me({render:H});customElements.define("project-card",Ve((function({project:e,handleInfoClick:t,handleInfoCloseClick:i,selected:s}){Ie((()=>{!function(e,t){const i=new IntersectionObserver((e=>{for(const s of e)if(s.isIntersecting){const e=s.target;t(e),i.unobserve(e)}}));i.observe(e)}(this,Ge)}),[]);const o="./images/"+e.imageSources[0];return j`
    ${Be}
...
`;const{component:Je}=Me({render:H});function Xe(e){e.preventDefault();const t=e.target.hash,i=document.querySelector(t),s=document.querySelector(De.HEADER),o=s?s.offsetHeight:0;if(i){const e=i.offsetTop-o;window.scroll({top:e,behavior:"smooth"}),history.pushState(null,"",t)}}customElements.define("project-list",Je((function(){const[e,t]=He(""),[i,s]=He(null),[o,n]=He(void 0),r=e=>{n(window.scrollY);const t=ze("section",this);scrollTo({top:t.offsetTop}),s(Oe(e.title))},a=()=>{var e,t;s(null),e=()=>scrollTo({top:o}),t=this,requestAnimationFrame((()=>{requestAnimationFrame((()=>{e.apply(t)}))})),n(void 0)},l=e=>Oe(e.title)===i,d=We.filter((t=>function(e,t){const{keywords:i,title:s}=t;return function(e,t){let i=!1;const s=e.toLowerCase().split(" ");for(let e=0;e<s.length;e++){const o=s[e].trim();i=t.toLowerCase().includes(o)}return i}(e,i.join(" ")+" "+s.toLowerCase())}(e,t)));return j`
    ${qe}
  ...
  <header class="navy border-bottom">
    <nav class="container">
      <a href="/#summary" @click=${Xe} class="button button-transparent">Summary</a>
      <a href="/#visuals" @click=${Xe} class="button button-transparent">Visuals</a>
      <a href="/#experience" @click=${Xe} class="button button-transparent">Experience</a>
    </nav>
  </header>
`,Ze=j`
...
`,tt=j`
  ...
  ${Ye}
  ${et}
`;H(tt,document.body);export{ze as e};
//# sourceMappingURL=app-e4b9569f.js.map
