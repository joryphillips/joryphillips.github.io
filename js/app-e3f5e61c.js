...
function elementSelector(query, context) {
    const el = (context.querySelector(query) ||
        context.shadowRoot?.querySelector(query));
    if (el)
        return el;
...
function showProjectAndLoadImage(element) {
    const lazyImage = elementSelector(Selector.PROJECT_IMAGE, element);
...
function ProjectList() {
    ...
    const handleInfoClick = (project) => {
        ...
        const sectionEl = elementSelector('section', this);
